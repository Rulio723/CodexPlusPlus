...
; Encoded PowerShell 5.1 Appx query. It validates Microsoft.PowerShell's
; package name, version, architecture, WindowsApps install root, real pwsh.exe
; file, and non-reparse executable before returning one absolute path.
!define POWERSHELL7_STORE_QUERY ""
...
Function DetectPowerShell7
  ...
  Call CheckPowerShell7StoreAppx
  StrCmp $PowerShell7Installed 1 powershell7_detect_done
...
Function CheckPowerShell7StoreAppx
  ; The Microsoft.PowerShell App Execution Alias is a 0-byte reparse file with
  ; no file version. Query the fixed Windows PowerShell Appx provider instead,
  ; and accept only its validated real WindowsApps pwsh.exe path.
  ; Query shape: Appx\Get-AppxPackage -Name Microsoft.PowerShell.
  ; Validation shape: Microsoft.PowerShell_<version>_<arch>__8wekyb3d8bbwe.
  ; AppExecutionAlias is never accepted as PowerShell7StorePath.
  StrCpy $PowerShell7StorePath ""
  nsExec::ExecToStack /TIMEOUT=30000 '"$SYSDIR\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -NonInteractive -ExecutionPolicy Bypass -EncodedCommand "${POWERSHELL7_STORE_QUERY}"'
  Pop $0
  Pop $1
  StrCmp $0 0 powershell7_store_appx_candidate
  Return

powershell7_store_appx_candidate:
  StrCpy $PowerShell7StorePath "$1"
  IfFileExists "$PowerShell7StorePath" 0 powershell7_store_appx_done
  StrCpy $PowerShell7Candidate "$PowerShell7StorePath"
  StrCpy $PowerShell7Installed 1

powershell7_store_appx_done:
FunctionEnd
