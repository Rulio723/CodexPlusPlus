...
; Keep the encoded command plus the fixed powershell.exe arguments below
; NSIS_MAX_STRLEN (1024). The Appx provider supplies the trusted package path;
; CheckPowerShell7Candidate then verifies that the returned file is PowerShell 7.
