...
export const EN_PLAIN: Record<string, string> = {
  ...
  "保存官方账号": "Save official account",
  "切换官方账号": "Switch official account",
  "重命名官方账号": "Rename official account",
  "删除官方账号": "Delete official account",
  ...
  "只切换 auth.json 官方登录凭据；不会修改供应商、config.toml 或混入 API Key":
    "Switches only the official login credentials in auth.json; providers, config.toml, and the mixed-in API Key are unchanged",
  "当前官方登录": "Current official login",
  "未检测到有效的 ChatGPT 官方登录": "No valid official ChatGPT login detected",
  "账号名称（可选）": "Account name (optional)",
  "保存当前账号": "Save current account",
  "切换后请手动重启 Codex。现有供应商配置和混入 API Key 将保持不变。":
    "Restart Codex manually after switching. Existing provider settings and the mixed-in API Key will remain unchanged.",
  "未解析到账号标识": "Account identity unavailable",
  "当前使用": "Current",
  "切换": "Switch",
  ...
  "添加官方账号": "Add official account",
  "保存新账号登录凭据": "Save new account credentials",
  "导出会话迁移包": "Export session migration package",
  "Codex++ 会话迁移包": "Codex++ session migration package",
  "会话导出": "Session export",
  "选择会话迁移包": "Select session migration package",
  "会话导入": "Session import",
  "Skill 管理": "Skill management",
  "选择包含 SKILL.md 的 Skill 文件夹": "Choose a Skill folder containing SKILL.md",
  "选择 SKILL.md 或 ZIP Skill 包": "Choose SKILL.md or a ZIP Skill package",
  ...
  "添加新账号会先加密保存当前官方登录并退出登录。是否继续？":
    "Adding a new account will encrypt the current official login and sign out. Continue?",
  "添加新账号": "Add new account",
  "待登录：请重启 Codex 并登录新的官方账号": "Sign-in pending: restart Codex and sign in to the new official account",
  "登录完成后回到这里保存登录凭据": "Return here after signing in to save the credentials",
  "保存登录凭据": "Save login credentials",
  "插件列表全量展示": "Show the full plugin list",
  "进入插件页后自动连续展开“更多”，尽量一次显示完整插件列表。":
    "Automatically expand “More” on the plugin page to show the full plugin list.",
  "经典项目侧栏": "Classic project sidebar",
  "忽略 Codex 的侧栏 A/B 实验，固定使用项目和会话直接展开的经典布局。需重启 Codex 才能生效。":
    "Ignore Codex's sidebar A/B experiment and use the classic layout with projects and sessions expanded directly. Restart Codex for this to take effect.",
  "壁纸资源（外链）": "Wallpaper resource (external link)",
  ...
  "导出全部": "Export all",
  "导入会话包": "Import session package",
  "导入或导出会话迁移包前必须完全退出 Codex；迁移包包含完整对话和本地项目路径，但不包含账号、API Key 或项目源码。":
    "Fully exit Codex before importing or exporting a session migration package. It includes complete conversations and local project paths, but not accounts, API keys, or project source code.",
  "导出已选": "Export selected",
  "管理员兼容模式会提升 Agent 受控命令、底部终端与 Computer Use；主 app-server 保持官方普通权限，以确保稳定兼容。":
    "Administrator compatibility mode elevates controlled Agent commands, the bottom terminal, and Computer Use; the main app-server keeps official standard privileges for compatibility.",
  "未运行": "Not running",
  "Codex++ launcher 当前未运行；管理员能力会在下一次通过 Codex++ 启动 Codex 后重新验证。":
    "The Codex++ launcher is not running; administrator capabilities will be revalidated the next time Codex starts through Codex++.",
  "正在验证管理员受控命令、底部终端与管理员 Computer Use。":
    "Verifying administrator controlled commands, the bottom terminal, and Administrator Computer Use.",
  "主 app-server：官方普通权限；底部终端：管理员权限（高完整性 Broker）":
    "Main app-server: official standard privileges; bottom terminal: administrator privileges (high-integrity broker)",
  "管理员受控命令": "Administrator controlled commands",
  "已提升": "Elevated",
  "未提升": "Not elevated",
  "管理员底部终端": "Administrator bottom terminal",
  "重新检测延迟": "Recheck latency",
  "此供应商没有单一目标 URL": "This provider has no single target URL",
  "不可用": "Unavailable",
  "管理 MCP、真实 SKILL.md Skills 和 Plugins；Skill 安装状态直接对应 Codex 用户目录。":
    "Manage MCP, real SKILL.md Skills, and Plugins; Skill installation state maps directly to the Codex user directory.",
  "传输兼容": "Transport compatibility",
  "模拟官方 Codex 指纹": "Emulate the official Codex fingerprint",
  "为此供应商启用固定的 Codex 风格 User-Agent、TLS/HTTP2 协商参数；默认关闭。":
    "Enable fixed Codex-style User-Agent and TLS/HTTP2 negotiation parameters for this provider; off by default.",
  "MCP 与插件配置随供应商同步；Skills 直接读取 Codex 的 SKILL.md 安装目录。":
    "MCP and plugin configuration syncs with the provider; Skills read the Codex SKILL.md installation directory directly.",
  "导入 Skill 文件夹": "Import Skill folder",
  "导入文件 / ZIP": "Import file / ZIP",
  "搜索 Skill": "Search Skills",
  "搜索名称、描述或路径": "Search by name, description, or path",
  "全部来源": "All sources",
  "用户安装": "User-installed",
  "系统内置": "System built-in",
  "插件提供": "Plugin-provided",
  "刷新 Skill": "Refresh Skills",
  "配置无效": "Invalid configuration",
  "无法解析 SKILL.md": "Could not parse SKILL.md",
  "禁用 Skill": "Disable Skill",
  "启用 Skill": "Enable Skill",
  "复制调用词": "Copy invocation",
  "没有匹配的 Skill。": "No matching Skill.",
  "尚未发现 Skill。可导入包含 SKILL.md 的文件夹、单个 SKILL.md 或 ZIP 包。":
    "No Skills found yet. Import a folder containing SKILL.md, an individual SKILL.md, or a ZIP package.",
  "用户安装 · 已禁用": "User-installed · Disabled",
  "只保留非 MCP、Plugins 的跨供应商配置；真实 Skills 由 SKILL.md 目录独立管理。":
    "Keep only non-MCP, non-Plugin cross-provider configuration; real Skills are managed independently from the SKILL.md directory.",
  "当前使用中：保留此供应商的 auth 存档，避免 Codex 登录密钥覆盖供应商密钥":
    "Currently in use: keep this provider's auth archive so Codex login credentials do not overwrite the provider key",
  "安全提示：网页链接中的自定义 config.toml 和 auth.json 不会执行；管理工具只会使用上方字段生成受管配置。":
    "Security note: custom config.toml and auth.json from web links are not executed; the manager only generates managed configuration from the fields above.",
  "导入会话迁移包": "Import session migration package",
  "确认会话、冲突处理和项目路径后再写入本机 Codex 数据。导入前会自动创建安全备份。":
    "Confirm sessions, conflict handling, and project paths before writing local Codex data. A safe backup is created before import.",
  "会话数量": "Session count",
  "附件文件": "Attachment files",
  "ID 冲突": "ID conflict",
  "来源版本": "Source version",
  "导出时间": "Export time",
  "冲突处理": "Conflict handling",
  "跳过已有会话（推荐）": "Skip existing sessions (recommended)",
  "备份后覆盖已有会话": "Overwrite existing sessions after backup",
  "已存在": "Existing",
  "可导入": "Importable",
  "无 rollout": "No rollout",
  "缺失的项目路径": "Missing project path",
  "项目已移动时填写新目录；留空则保留原路径。":
    "Enter a new directory when the project has moved; leave it empty to keep the original path.",
  "新的项目目录": "New project directory",
  "迁移包不会写入账号或 API Key；导入失败时可使用自动创建的安全备份恢复。":
    "Migration packages do not write accounts or API keys; if import fails, restore from the automatically created safe backup.",
  "正在导入…": "Importing…",
  "管理 MCP、真实 Skills 和 Plugins": "Manage MCP, real Skills, and Plugins",
  "会话删除、导出、项目移动和脚本能力": "Session deletion, export, project move, and script capabilities",
  "普通推荐": "General recommendations",
};
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "{0} 副本": "{0} copy",
  "保存时间：{0}": "Saved: {0}",
  "删除保存的官方账号“{0}”？当前 live 登录不会被删除。":
    "Delete the saved official account “{0}”? The current live login will not be deleted.",
  "供应商 {0}": "Provider {0}",
  ...
  "打开保存选择器失败：{0}": "Failed to open the save picker: {0}",
  ...
  "卸载 Skill“{0}”？文件会移动到安全备份目录，可手动恢复。":
    "Uninstall Skill “{0}”? Files will move to a safe backup directory and can be restored manually.",
  "已复制调用词 {0}，粘贴到 Codex 输入框即可使用。":
    "Copied invocation {0}; paste it into the Codex input box to use it.",
  "{0} ms": "{0} ms",
  "当前读取到 {0} 个真实 Skill；用户 Skill 可导入、启停和卸载，系统与插件 Skill 为只读。":
    "Read {0} real Skill(s); user Skills can be imported, enabled, disabled, and uninstalled, while system and plugin Skills are read-only.",
  "启用 {0}": "Enable {0}",
  "用户 {0}": "User {0}",
  "插件 {0}": "Plugin {0}",
  "插件 · {0}": "Plugin · {0}",
  "另外还有 {0} 个会话": "and {0} more session(s)",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "官方账号名称已更新。": "Official account name updated.",
  "已删除保存的官方账号副本。": "Saved official account copy deleted.",
  "官方账号列表已读取。": "Official account list loaded.",
  "当前官方账号已加密保存。": "Current official account saved with encryption.",
  "官方账号已切换。请手动重启 Codex 后生效。": "Official account switched. Restart Codex manually for the change to take effect.",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/^重命名官方账号失败：(.+)$/, "Failed to rename official account: $1"],
  [/^删除官方账号失败：(.+)$/, "Failed to delete official account: $1"],
  [/^读取官方账号列表失败：(.+)$/, "Failed to load official account list: $1"],
  [/^保存当前官方账号失败：(.+)$/, "Failed to save current official account: $1"],
  [/^切换官方账号失败：(.+)$/, "Failed to switch official account: $1"],
